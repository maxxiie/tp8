...
$recipes["Tart"]["equipment"][]  = "Stove";
$recipes["Tart"]["equipment"][]  = "Sauce Pan";
$recipes["Tart"]["equipment"][]  = "Measuring Pans";
$recipes["Tart"]["equipment"][]  = "Baking Sheet";
$recipes["Tart"]["equipment"][]  = "Fine-mesh Strainer";

$recipes["Tart"]["ingredients"][]  = "6 tablespoons unsalted butter";
$recipes["Tart"]["ingredients"][]  = "1 ¼ cups all-purpose flour";
$recipes["Tart"]["ingredients"][]  = "6 tablespoons white sugar";
$recipes["Tart"]["ingredients"][]  = "¼ teaspoon ground cinnamon";
$recipes["Tart"]["ingredients"][]  = "1/8 teaspoon salt";
$recipes["Tart"]["ingredients"][]  = "Custard:";
$recipes["Tart"]["ingredients"][]  = "1 ¾ cups light cream";
$recipes["Tart"]["ingredients"][]  = "⅓ cup white sugar";
$recipes["Tart"]["ingredients"][]  = "4 teaspoons cornstarch";
$recipes["Tart"]["ingredients"][]  = "4 egg yolks";
$recipes["Tart"]["ingredients"][]  = "1 tablespoon unsalted butter";
$recipes["Tart"]["ingredients"][]  = "1 teaspoon vanilla extract";
$recipes["Tart"]["ingredients"][]  = "1 tablespoon kirschwasser";
$recipes["Tart"]["ingredients"][]  = "1 (11 inch) shortbread tart crust, baked";
$recipes["Tart"]["ingredients"][]  = "⅔ cup apricot preserves";
$recipes["Tart"]["ingredients"][]  = "2 tablespoons water";
$recipes["Tart"]["ingredients"][]  = "2 ½ pints fresh raspberries";
$recipes["Tart"]["ingredients"][]  = "2 ½ tablespoons sifted confectioners' sugar";

$recipes["Tart"]["directions"][]  = "Preheat oven to 350 degrees F (175 degrees C).";
$recipes["Tart"]["directions"][]  = "Place 6 tablespoons butter in a saucepan. Melt over medium-low heat. Cool until barely warm.";
$recipes["Tart"]["directions"][]  = "Combine flour, 6 tablespoons sugar, cinnamon, and salt and add to melted butter. Toss with a fork until crumbs are formed.";
$recipes["Tart"]["directions"][]  = "Take a clump of the crumb mixture in your hand and squeeze gently forming a larger clump. Break larger clump apart.";
$recipes["Tart"]["directions"][]  = "Sprinkle crumbs onto a large shallow pan. Repeat until all the mixture has been made into crumbs. Place crumbs in oven and bake for 15 to 18 minutes until they turn light brown. Set streusel mixture aside to cool and harden.Pour condensed milk over nuts.";
$recipes["Tart"]["directions"][]  = "Heat cream in a 2-quart saucepan until just under a boil. In a small bowl, combine 1/3 cup sugar and cornstarch. Beat egg yolks in a mixing bowl with a whisk until slightly thickened. Whisk in sugar-cornstarch mixture. Gradually pour in hot cream, whisking constantly. Return mixture to saucepan. Heat slowly, stirring constantly with a wooden spoon, until mixture begins to thicken and comes to a boil. Be sure to reach all parts of the pot to release any custard that may stick.";
$recipes["Tart"]["directions"][]  = "After custard reaches a boil, simmer about 1 minute. Remove from heat. Stir in 1 tablespoon butter, vanilla, and Kirschwasser or framboise. Cover custard with a piece of buttered plastic wrap. Cool about 10 minutes.";
$recipes["Tart"]["directions"][]  = "Spread custard into a prebaked tart shell and bake for until bubbly, 20 to 25 minutes. Remove from oven and cool on a rack for 10 minutes to set.";
$recipes["Tart"]["directions"][]  = "Combine preserves and water in a small saucepan. Heat until mixture comes to a boil. Pass the glaze through a fine-mesh strainer. Discard pulp.";
$recipes["Tart"]["directions"][]  = "Gently brush top of custard with half of the hot preserves. Sprinkle berries generously over hot custard. Lightly brush tops of berries with remaining preserves. Sprinkle tart generously with streusel, pressing the crumbs gently into the berries so they will stick. Chill tart, uncovered, for about 2 hours. Just before serving, sift confectioners' sugar on top.";
